...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Produk Terjual</h3>
...
<table class="table">
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>		
				<a href="edit_laku.php?id=<?php echo $b['id']; ?>" class="glyphicon glyphicon-pencil"></a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_laku.php?id=<?php echo $b['id']; ?>&jumlah=<?php echo $b['jumlah'] ?>&nama=<?php echo $b['nama']; ?>' }" class="glyphicon glyphicon-trash"></a>
			</td>
		</tr>
