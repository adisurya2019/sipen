...
<table class="table table-hover">
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				<a href="det_barang.php?id=<?php echo $b['id']; ?>" class="glyphicon glyphicon-list"></a>
				<a href="edit.php?id=<?php echo $b['id']; ?>" class="glyphicon glyphicon-pencil"></a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus.php?id=<?php echo $b['id']; ?>' }" class="glyphicon glyphicon-trash"></a>
			</td>
		</tr>		
		<?php 
	}
