...
$pdf->Image('../logo/Aiko.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Dessert By AIKO',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 081234876500',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Amlapura-Singaraja',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'email : Aiko@gmail.com',0,'L');
...
$pdf->Cell(6, 0.8, 'Nama Produk', 1, 0, 'C');
